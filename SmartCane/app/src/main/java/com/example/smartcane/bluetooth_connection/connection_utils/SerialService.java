...
//        if (connected)
    ...
    private void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel nc = new NotificationChannel(BluetoothConstants.NOTIFICATION_CHANNEL, "Background service", NotificationManager.IMPORTANCE_LOW);
            nc.setShowBadge(false);
            NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(nc);
        }
        Intent disconnectIntent = new Intent()
                .setAction(BluetoothConstants.INTENT_ACTION_DISCONNECT);
        Intent restartIntent = new Intent()
                .setClassName(this, BluetoothConstants.INTENT_CLASS_MAIN_ACTIVITY)
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, BluetoothConstants.NOTIFICATION_CHANNEL)
        ...
        startForeground(BluetoothConstants.NOTIFY_MANAGER_START_FOREGROUND_SERVICE, notification);
    }
